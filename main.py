...
def main():
    ...
    while True:
        ...
        canvas.blit(text_destination1, (1495 - text_destination1.get_width() // 2, 203 - text_destination1.get_height() // 2))
        ...
        canvas.blit(text_destination2, (1495 - text_destination2.get_width() // 2, 338 - text_destination2.get_height() // 2))
